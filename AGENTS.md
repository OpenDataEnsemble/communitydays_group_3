# Education — Group 3: agent and developer guide
...
- **Theme:** Education.
- **Register:** learning club (`group_3_registration`).
- **Follow-up action:** Record a club session (`group_3_followup`).
...
| Registration questions | `forms/group_3_registration/schema.json` and `ui.json` |
| Follow-up questions | `forms/group_3_followup/schema.json` and `ui.json` |
