# Education App — Group 3

**ODE Community Days 2026, Kampala**

Register learning clubs, open their details, and select **Record a club session** to save a linked follow-up. Both forms ask only three questions.
...
- `forms/group_3_registration/`: registration schema and layout.
- `forms/group_3_followup/`: follow-up schema and layout.
...
1. Install the bundle in Formulus/Desktop and register two fictional learning clubs.
2. Close each saved form: the table should update without pressing Refresh. Cancel a third form: no draft should appear.
3. Open the first row, select **Record a club session**, and save. Its history should update; the second row must not show that follow-up.
